...
const REMIX_IDEAS = [
    "to see yourself in different historical eras.",
    "to try different hair styles and colors.",
    "to generate a professional headshot.",
    "to create a fantasy character version of yourself.",
    "to see yourself as a cartoon character.",
    "to place yourself in famous paintings.",
];
